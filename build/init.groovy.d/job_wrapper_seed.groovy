...
def jobName = "Job-Wrapper-Seed-debug"
def configXml = """\
<?xml version='1.0' encoding='UTF-8'?>
<project>
  <actions/>
  <description>Create new jobs from groovy scripts in ci-builder-scripts project</description>
...
"""
def gitUrl = System.getenv('LSDEV_JOB_WRAPPER_GIT_URL');
if (gitUrl?.trim()) {
    configXml = configXml.replaceAll('JOB_WRAPPER_GIT_URL', gitUrl);
}
def gitBranch = System.getenv('LSDEV_JOB_WRAPPER_GIT_BRANCH');
if (gitBranch?.trim()) {
